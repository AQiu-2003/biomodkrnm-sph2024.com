...
<HeadingWithTuntun title='Background'>
  <Image
    ...
    width={100}
    height={100}
    className='absolute -top-[5rem] right-4 mx-auto w-32 md:-top-[8rem] md:w-44 lg:-top-[7.5rem]'
  />
</HeadingWithTuntun>

![300@Fig 1. Global cancer statistics](./fig1.png)
...
![200@Fig 2. Challenges of NSCLC radiotherapy and novel sensitization strategies](./fig2.png)
...
![200@Fig 3. Construction of a multifunctional nanosystem Crimson Crusader for targeted therapy and radiotherapy sensitization of NSCLC](./fig3.png)
