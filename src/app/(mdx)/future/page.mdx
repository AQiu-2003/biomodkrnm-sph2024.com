...
3. **Enhancement of Tumor Targeting:** The targeting efficiency of the nano-complex can be improved by functionalizing the surface of AuNP susing tumor cell-specific antibodies or ligands, which would enhance their selective binding to tumor cells.
